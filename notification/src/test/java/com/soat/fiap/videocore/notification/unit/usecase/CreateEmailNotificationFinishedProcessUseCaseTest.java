 ...
 * {@link CreateEmailNotificationFinishedProcessUseCase}.
 */
class CreateEmailNotificationFinishedProcessUseCaseTest {

	private final CreateEmailNotificationFinishedProcessUseCase useCase = new CreateEmailNotificationFinishedProcessUseCase();
	...
	void shouldCreateNotificationWhenInputIsValid() {
		...
		// Act
		Notification notification = useCase.createEmailNotificationFinishedProcess(user, input, "http://download");

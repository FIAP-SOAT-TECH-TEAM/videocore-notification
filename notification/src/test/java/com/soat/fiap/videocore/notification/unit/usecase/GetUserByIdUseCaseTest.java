...
class GetUserByIdUseCaseTest {
	...
	void shouldThrowExceptionWhenIdIsNull() {
		// Arrange & Act
		var ex = assertThrows(UserException.class, () -> useCase.getUserById(null));
	...
	void shouldThrowExceptionWhenIdIsBlank() {
		// Arrange & Act
		var ex = assertThrows(UserException.class, () -> useCase.getUserById(" "));
	...
	void shouldThrowExceptionWhenUserIsNotFound() {
		...
		// Act
		var ex = assertThrows(UserNotFoundException.class, () -> useCase.getUserById(userId));

...
```
mkdir -p notification/src/main/resources/META-INF/native-image
```
...
```
build/libs/notification-0.0.1.jar
```
...
```
java -agentlib:native-image-agent=config-output-dir=../../src/main/resources/META-INF/native-image/ -jar notification-0.0.1.jar
```
...
```
notification/src/main/resources/META-INF/native-image
```

...
/**
 * Controller responsável por orquestrar o processamento de erro no processamento de um vídeo.
 */
@Component
...
public class ProcessVideoErrorController {
    ...
    /**
     * Processa o erro no processamento de um vídeo através do payload de evento: {@link ProcessVideoErrorPayload}.
     *
     * @param payload Payload de erro no processamento de um vídeo.
     */

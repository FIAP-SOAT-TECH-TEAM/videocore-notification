 ...
 * detalhes sobre a atualização do status de processamento de um vídeo.
 *
 * @param videoName
 *            Nome do vídeo.
 * @param userId
 ...
 */
public record ProcessVideoStatusUpdateInput(String videoName, String userId, String requestId, String traceId,

...
/**
 * Caso de uso responsável por criar uma notificação por e-mail informando a
 * finalização do processamento de um vídeo.
 */
...
public class CreateEmailNotificationFinishedProcessUseCase {
	 ...
	 * @param downloadUrl
	 *            URL de download para as imagens do vídeo
	 * @return notificação de e-mail construída
	 */
	@WithSpan(name = "usecase.create.notification.finished.process")
	public Notification createEmailNotificationFinishedProcess(UserDTO userDTO, ProcessVideoStatusUpdateInput input,
			String downloadUrl) {
		...
		var messageText = "<div style=\"font-family:Arial, Helvetica, sans-serif; color:#1f2937;\">"
				...
				+ "<h2 style=\"margin:0; font-size:20px;\">🎉 Seu vídeo foi processado com sucesso</h2>" + "</div>"
				...
				+ "<ul style=\"padding-left:20px;\">" + "<li><strong>⏱️ Intervalo de captura: </strong>"
				+ frameCutMinutes + " minuto(s)</li>" + "<li><strong>🕒 Finalizado em: </strong>" + formattedReportTime
				+ "</li>" + "</ul>" + "<p style=\"margin-top:16px;\">📥 <strong>Acesso às imagens:</strong></p>"
				+ "<p><a href=\"" + downloadUrl
				+ "\" style=\"color:#1d4ed8; text-decoration:none; font-weight:bold;\">Clique aqui para realizar o download</a></p>"
				...
				+ "<strong>Request ID: </strong>" + requestId + "</p>" + "</div>"

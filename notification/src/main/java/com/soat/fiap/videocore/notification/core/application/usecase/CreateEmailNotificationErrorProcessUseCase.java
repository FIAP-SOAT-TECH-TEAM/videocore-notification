    ...
    public Notification createEmailNotificationErrorProcess(UserDTO userDTO, ProcessVideoErrorInput input) {
        ...
        var messageText =
                "<div style=\"font-family:Arial, Helvetica, sans-serif; color:#1f2937;\">" +
                        ...
                        "}" +
                        "</style>" +
                        "<h2 style=\"margin:0; font-size:20px;\">❌ Não foi possível concluir o processamento</h2>" +
                        "</div>" +
                        ...
                        "<li><strong>📊 Percentual processado: </strong>" + percentStatusProcess + "%</li>" +
                        "<li><strong>⏱️ Intervalo de captura: </strong>" + frameCutMinutes + " minuto(s)</li>" +
                        "<li><strong>🕒 Data do erro: </strong>" + formattedReportTime + "</li>" +
                        "</ul>" +

...
public class GetVideoImagesDownloadUrlUseCase {
	...
	/**
	 * Recupera a URL de download das imagens de um vídeo a partir das chaves de
	 * negócio, utilizando um tempo de expiração de 30 minutos.
	 *
	 * @param userId
	...
	public String getVideoImagesDownloadUrl(String userId, String requestId, String videoName) {
		...
		if (downloadUrl == null || downloadUrl.isBlank())
			throw new VideoImageDownloadUrlNotFoundException(
					"URL de download do arquivo de imagens do vídeo informado não encontrada. UserID: %s, RequestID: %s e VideoName: %s",
					userId, requestId, videoName);

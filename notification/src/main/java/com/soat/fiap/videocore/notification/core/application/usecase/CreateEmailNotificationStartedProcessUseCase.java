...
/**
 * Caso de uso responsável por criar uma notificação por e-mail informando o
 * início do processamento de um vídeo.
 */
...
public class CreateEmailNotificationStartedProcessUseCase {
	...
	public Notification createEmailNotificationStartedProcess(UserDTO userDTO, ProcessVideoStatusUpdateInput input) {
		...
		var messageText = "<div style=\"font-family:Arial, Helvetica, sans-serif; color:#1f2937;\">"
				...
				+ "<h2 style=\"margin:0; font-size:20px;\">🚀 Processamento iniciado</h2>" + "</div>"
				...
				+ "<p style=\"margin-top:16px;\">As imagens serão capturadas a cada <strong>" + frameCutMinutes
				+ " minuto(s)</strong>.</p>"
				+ "<p style=\"margin-top:16px;\"><strong>Informações do processo:</strong></p>"
				+ "<ul style=\"padding-left:20px;\">" + "<li><strong>🕒 Início: </strong>" + formattedReportTime
				+ "</li>" + "<li><strong>🧩 Trace ID: </strong>" + traceId + "</li>"
				+ "<li><strong>📄 Request ID: </strong>" + requestId + "</li>" + "</ul>"
